...
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-485.exe
ren C:\MinGW\mingw64 mingw64-485
ren C:\MinGW\mingw32 mingw32-485
del libwinpthread-1.dll
ren C:\MinGW\mingw64-493 mingw64
ren C:\MinGW\mingw32-493 mingw32
copy "C:\MinGW\mingw64\x86_64-w64-mingw32\lib\libwinpthread-1.dll" "C:\Users\Andrea\Documents\GitHub\StockfishVariants\CorCfishExtended\cpp Language\srcWindows\libwinpthread-1.dll"
cd "C:\Users\Andrea\Documents\GitHub\StockfishVariants\CorCfishExtended\cpp Language\srcWindows"
make clean
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-493.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-494.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-540.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-620.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-630.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-640.exe
ren C:\MinGW\mingw64 mingw64-640
ren C:\MinGW\mingw32 mingw32-640
del libwinpthread-1.dll
ren C:\MinGW\mingw64-710 mingw64
ren C:\MinGW\mingw32-710 mingw32
copy "C:\MinGW\mingw64\x86_64-w64-mingw32\lib\libwinpthread-1.dll" "C:\Users\Andrea\Documents\GitHub\StockfishVariants\CorCfishExtended\cpp Language\srcWindows\libwinpthread-1.dll"
cd "C:\Users\Andrea\Documents\GitHub\StockfishVariants\CorCfishExtended\cpp Language\srcWindows"
make clean
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-710.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corchessextended.exe
ren corchessextended.exe CorChessExtended-010718-x86-64-bmi2-720.exe
make clean
