/*
	StockfValue DrawValue[COLOR_NB];ish, a UCI chess playing engine derived from Glaurung 2.1
...
void MainThread::search() {
  ...
  int contempt = Options["Dynamic contempt"] * PawnValueEg / 100; // From centipawns
