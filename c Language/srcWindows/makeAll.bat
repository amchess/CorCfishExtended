...
ren corcfishextended.exe "CorCFishExtended 041217 x86-64.exe"

make clean
mingw32-make -f MakeFile build ARCH=x86-64-modern COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 x86-64-modern.exe"

make clean
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 x86-64-bmi2.exe"

make clean
mingw32-make -f MakeFile build ARCH=x86-32 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 x86-32.exe"

make clean
mingw32-make -f MakeFile build ARCH=x86-32-old COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 x86-32-old.exe"

make clean
mingw32-make -f MakeFile build ARCH=ppc-64 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 ppc-64.exe"

make clean
mingw32-make -f MakeFile build ARCH=ppc-32 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 ppc-32.exe"

make clean
mingw32-make -f MakeFile build ARCH=armv7 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 armv7.exe"

make clean
mingw32-make -f MakeFile build ARCH=general-64 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 general-64.exe"

make clean
mingw32-make -f MakeFile build ARCH=general-32 COMP=mingw
strip corcfishextended.exe
ren corcfishextended.exe "CorCFishExtended 041217 general-32.exe"
